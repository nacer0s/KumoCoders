...
import GalleryGrid from './pages/GalleryGrid.jsx'
...
function getRoute() {
  ...
  if (path === '/gallery' || path === '/gallery/') return { route: 'list', params: {} }
  const detailMatch = path.match(/^\/gallery\/([^/]+)$/)
  ...
  return (
    <>
      ...
      <main className="gallery-main">
        {route === 'detail' ? (
          <GalleryDetail slug={params.slug} navigateTo={navigateTo} />
        ) : (
          <GalleryGrid navigateTo={navigateTo} />
        )}
      </main>
