...
import WikiDetail from './pages/WikiDetail.jsx'
...
function getRoute() {
  ...
  if (path === '/wiki' || path === '/wiki/') return { route: 'list', params: {} }
  const detailMatch = path.match(/^\/wiki\/([^/]+)$/)
  ...
  return (
    <>
      ...
      <main className="wiki-main">
        {route === 'detail' ? <WikiDetail slug={params.slug} navigateTo={navigateTo} /> : <WikiList navigateTo={navigateTo} />}
      </main>
